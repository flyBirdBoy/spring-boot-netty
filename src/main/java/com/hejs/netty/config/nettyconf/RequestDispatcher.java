...
import com.hejs.netty.util.netty.NullWritable;
import com.hejs.netty.util.netty.ResponseCodeEnum;
import com.hejs.netty.util.netty.ResponseResult;
import com.hejs.netty.util.netty.ResponseResultUtil;
 ...
 * @Author: hejis
 * @Description: 请求分排器
 * @Date: Create in 14:57 2018/7/9
 * @Modified By:
 */
@Component
public class RequestDispatcher implements ApplicationContextAware {

    private ExecutorService executorService = newFixedThreadPool(NettyConstanct.getMaxThreads());
